    ...
    <div class="card">
        <form class="card-form" onclick="return false">
            ...
            <div class="css-15651n7">
                <div class="css-xjlny9"><?php echo L('图形验证码');?></div>
                <div class="css-hiy16i" style="height: 48px;">
                    ...
                    <div class="css-13xytqh" style="width:30%;float:right;">
                        <img style="width:100%;height:50px;border-radius:5px;;cursor:pointer;" src="<?php echo U('Verify/code');?>" onclick="this.src=this.src+'?t='+Math.random()" title="<?php echo L('换一张');?>">
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="input" id="yzm">
                ...
                <div class="action-button login-send-button tcc" onclick="emailsend();" style="background-color: rgba(255,255,255,0.5);width: 30%;line-height: 38px;">
                     <span class="f12 fcy" id="smsstr" style="margin: 0px;color: #fff"><?php echo L('获取验证码');?></span>
