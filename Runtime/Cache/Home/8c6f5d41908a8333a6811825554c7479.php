	                               ...
	                               <div class="css-jjjwcg">
	                                   <div class="css-15owl46">
	                                       <div class="btitle">
	                                           ...
	                                           <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14"><?php echo L('冻结周期');?>&nbsp;&nbsp;&nbsp;<?php echo L('收益比例');?></span>
	                                           </div>
	                                            <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14"><?php echo L('当前收益');?></span>
	                                           </div>
	                                            <div class="btitleop" style="width:10%;">
	                                               <span class="fch f14"><?php echo L('预估总收益');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:15%;">
	                                       ...
	                                       <div style="width:100%;height:400px;overflow: auto;">
	                                           ...
	                                           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div style="width:100%;height:60px;background:#fff;border-bottom:1px solid #f5f5f5;">
	                                                ...
	                                                <div class="bcontentop" style="width:10%;">
	                                                    <span class="fch f14"><?php echo ($vo["onum"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:15%;">
	                                                    <span class="fch f14"><?php echo ($vo["mum"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:10%;">
	                                                    <span class="fch f14"><?php echo ($vo["lockday"]); echo L('天');?> (+<?php echo ($vo["lixi"]); ?>% / <?php echo L('天');?>)</span>
	                                                </div>
	                                                 <div class="bcontentop" style="width:10%;">
	                                                    <span class="fch f14"><?php echo ($vo["lixi_money"]); ?></span>
	                                                </div>
	                                                 <div class="bcontentop" style="width:10%;">
	                                                    <span class="fch f14"><?php echo ($vo["yugu"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:15%;">
