                            ...
                            <div style="width:60%;min-height:900px;background:#1a1b1c;float:left;">
                                ...
                                <div style="width:100%;height:600px;padding:5px;">
                                    <div style="width:100%;height:600px;">
                                        <div style="width:100%;height:600px;">
			                                <iframe id="iframeid" width="100%" scrolling="no" height="600px" src="<?php echo U('Trade/ordinary');?>?market=<?php if($market == "mbnusdt"){echo "usdzusdt"; }else{ echo $market; } ?>"  noresize="noresize" frameborder="0" ><?php echo L('不支持IFRAME，请升级');?></iframe>
			                            </div>
                                    </div>
                                </div>
