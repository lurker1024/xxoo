        ...
        input.setAttribute("value", zzmoney);  //为input对象设置value属性和值  
	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                       ...
	                       <div id="moeny9">
	                                      <div class="czbox">
	                                          ...
	                                          <div class="czbox_2">
	                                              ...
	                                              <div class="czbox_4">
	                                                  <input class="czbox_5" type="number" id="usdtmoney" name="usdtmoney" />
	                                              </div>
	                                          </div>
	                                      </div>
	                                      <button onclick="submit_money()" class="czbox_4" style="margin-left:30%;width:60%;background: linear-gradient(to left,#eeb80d,#ffe35b);text-align:center;cursor:pointer;"><?php echo L('提交');?> <?php echo L('充值数量');?></button> 
	                  ...
	                  <div id="moeny10" > <!--style="display:none;"-->
	                                      ...
	                                      <div class="czbox" style="margin-bottom:0px;">
	                                          ...
	                                          <div class="czbox_2">
	                                              ...
	                                              <div class="czbox_4">
	                                                  <span class="fch f14" id="czline"><?php echo ($info["czline"]); ?></span>
	                                              </div>
	                                          </div>
	                                      </div>
	                                      ...
	                                      <div class="czbox">
	                                          ...
	                                          <div class="czbox_2">
	                                              ...
	                                              <div class="czbox_4">
	                                                  <input class="czbox_5" type="text" id="zznum" name="zznum" value="<?php echo $_GET['money'] ?>" disabled/>
	                                              </div>
	                                          </div>
	                                      </div>
...
<script>
    ...
    <script type="text/javascript">
        $("#sumbtn").click(function(){
            ...
            var czline = document.getElementById('czline').innerText;
            ...
            {'cid' : cid,'zznum':zznum,'czline':czline,'czaddress':czaddress,'payimg':payimg,'coinname':coinname},
            function(data){
                if(data.code == 1){
                    layer.msg(data.info);
