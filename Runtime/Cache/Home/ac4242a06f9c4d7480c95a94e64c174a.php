	                                           ...
	                                           <div class="css-5x6ly7">
	                                               ...
	                                               <div class="css-10nf7hq">
	                                                   <a class="css-1s6nhe2 f12" style="cursor:pointer;">
	                                                       <span onclick="allread();" style="color:#00b897;"><?php echo L('标记已读');?></span>
	                                                   </a>
	                                       ...
	                                       <div class="css-1dcd6pv">
	                                           ...
	                                           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="css-1pysja1">
	                                               <div class="css-kc3i4p">
	                                                   ...
	                                                   <div class="css-phax11">
	                                                       <div class="css-4cffwv">
	                                                           <?php if($vo["status"] == 1): ?><div data-bn-type="text" class="css-cvky42" style="color:#e54c67;"><?php echo L('未读');?></div>
	                                                           <?php elseif($vo["status"] == 2): ?>
	                                                           <div data-bn-type="text" class="css-cvky42" style="color:#3db485;"><?php echo L('已读');?></div><?php endif; ?>
	                                                       </div>
	                                                   </div>
	                                                   <div class="css-phax11">
	                                                       <div data-bn-type="text" class="css-1g02g2m">
	                                                           
	                                                           <?php if($vo["status"] == 1): ?><span onclick="setread(<?php echo ($vo["id"]); ?>);" style="color:#3db485;cursor:pointer;font-size:12px;"><?php echo L('标记已读');?></span><?php endif; ?>
	                                                           
	                                                           <span onclick="delone(<?php echo ($vo["id"]); ?>);" style="color:#e54c67;cursor:pointer;font-size:12px;"><?php echo L('删除');?></span>
	                                                       </div>
	                                                   </div>
	                                               </div>
