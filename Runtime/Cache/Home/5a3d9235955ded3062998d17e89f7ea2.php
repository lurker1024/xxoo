	                    ...
	                    <div class="css-1wr4jig">
                            ...
                            <div class="css-1bbywci">
                                ...
                                <!-- <div class="css-vurnku">
	                                         ...
	                                         <div class="css-vurnku">
	                                            <div class="css-154a57d">
	                                                <input data-bn-type="input" id="real_name" placeholder="<?php echo L('请输入真实姓名');?>" class="css-16fg16t" value="<?php echo ($info["real_name"]); ?>">
	                                                <label class="bn-input-label css-5vzups">
	                                                    <div data-bn-type="text" class="css-kiaw5d"><?php echo L('真实姓名');?></div>
	                                                </label>
	                                            </div>
	                                        </div>
...
<script>
    ...
    <script type="text/javascript">
        $("#sumbtn").click(function(){
            ...
            if(real_name == ''){
                layer.msg("<?php echo L('请输入真实姓名');?>");return false;
            }
            ...
            {'phone' : phone,'real_name':real_name,'cardzm':cardzm,'cardfm':cardfm},
            function(data){
                if(data.code == 1){
                    layer.msg(data.info);
