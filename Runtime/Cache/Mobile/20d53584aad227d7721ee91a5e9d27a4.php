...
<head>
	...
	<style>
	    ...
	    .lbox{width:100%;height:50px;margin: 10px 0px;background: #2C3445;border-radius: 10px;padding: 0px 10px;}
	    ...
	    .infobox{width:100%;padding:5px 20px;margin-top:50px;}
	    .infotbox{width:100%;height:50px;line-height:50px; text-align: center;}
...
<body  style="background: #121420;">
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="infobox">
		    ...
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('合约金额');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fe6im fzmmm"><?php echo ($info["num"]); ?>USDT</span>
		        </div>
		    </div>
		    
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('合约时长');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fe6im fzmmm"><?php echo ($info["time"]); echo L('分钟');?></span>
		        </div>
		    </div>
		    
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('合约类型');?></span>
		        </div>
		        <div class="lbox_r">
		    ...
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('合约状态');?></span>
		        </div>
		        <div class="lbox_r">
		            <?php if($info['status'] == 2){?>
		                <span class="fe6im fzmm"><?php echo L('结算成功');?></span>
		            <?php }elseif($info['status'] == 3){?>
		                <span class="fe6im fzmm"><?php echo L('失效结算');?></span>
		            <?php }elseif($info['status'] == 1){?>
		                <span class="fe6im fzmm"><?php echo L('未结算');?></span>
		            <?php }?>
		        </div>
		    </div>
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('建仓单价');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fe6im fzmm"><?php echo ($info["buyprice"]); ?></span>
		        </div>
		    </div>
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('建仓时间');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fe6im fzmm"><?php echo ($info["buytime"]); ?></span>
		        </div>
		    </div>
		    
		    <?php if($info["status"] == 2): ?><div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('平仓单价');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fe6im fzmm"><?php echo ($info["sellprice"]); ?></span>
		        </div>
		    </div>
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('平仓时间');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fe6im fzmm"><?php echo ($info["selltime"]); ?></span>
		        </div>
		    </div>
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fe6im fzmm"><?php echo L('盈亏金额');?></span>
		        </div>
		        <div class="lbox_r">
