...
<head>
	...
	<style>
        ...
        .btitle{width:100%;height:35px;line-height:35px;text-align:center;background:#1b1d2a;margin-top:10px;border-radius:15px;}
        ...
        .btnbox{width:100%;height:70px;position:fixed;bottom:0px;}
        .btnaddress{width:92%;height:40px;line-height:40px;background: #00b897;color: #fff;margin:0px auto;text-align:center;margin-top:15px;border-radius:10px;}
	...
	<div class="container-fluid " style="padding:0px;width:100vw;">
		<div class="no_header">
			...
			<div class="contentbox_top">
				<span class="fe6im" style="font-size:18px;font-weight:500;"><?php echo L('提币地址管理');?></span>
			</div>
		...
		<div class="contentbox">
            ...
            <div class="btitle">
                <span class="fzmm fe6im"><?php echo strtoupper($coinname);?></span>
            </div>
            
            <?php if(empty($qblist)): ?><div style="width:100%;height:300px;line-height:300px;text-align:center;">
                <span class="fzmm fe6im"><?php echo L('没有保存地址');?></span>
            </div>
            <?php else: ?>
            <?php if(is_array($qblist)): foreach($qblist as $key=>$vo): ?><div class="addbox">
                <div class="addressbox">
                    <span class="fzmmm fe6im"><?php echo ($vo["remark"]); ?></span>
                </div>
                <div class="address">
                    <span class="fzmmm fe6im"><?php echo ($vo["addr"]); ?></span>
                </div>
		...
		<div class="btnbox">
		    ...
		    <div class="btnaddress">
		        <span class="fzmm fe6im"><?php echo L('添加地址');?></span>
		    </div>
		    </a>
		</div>
	</div>
