...
<head>
	...
	<style>
        ...
        .tlistbox{width:100%;clear:both;padding:10px 0px 20px;}
		                ...
		                <div class="tlistbox_6">
		                    <div class="tlistbox_7 fl" style="width:30%;height:60px;">
		                        ...
		                        <div class="tlistbox_9 tl">
		                            <span class="fzmm fch"><?php echo ($vo["onum"]); ?><br><?php echo L('收益比例');?><br><?php echo ($vo["lixi"]); ?> % /<?php echo L('天');?></span>
		                        </div>
		                    </div>

		                    <div class="tlistbox_7 fl" style="width:40%;height:60px;">
		                        <div class="tlistbox_8 tc">
		                            <span class="fzm fcc"><?php echo L('支付金额');?></span>
		                        </div>
		                        <div class="tlistbox_9 tc">
		                            <span class="fzmm fch"><?php echo ($vo["mum"]); ?><br><?php echo L('当前收益');?><br><?php echo ($vo["lixi_money"]); ?></span>
		                        </div>
		                    </div>
		                    ...
		                    <div class="tlistbox_7 fl" style="width:30%;height:60px;">
		                        ...
		                        <div class="tlistbox_9 tr">
		                            <span class="fzmm fch"><?php echo ($vo["endday"]); ?> <br><?php echo L('预估总收益'); echo ($vo["yugu"]); ?><br></span>
		                        </div>
		                    </div>
		                </div>
