...
<body>
<div class="container-fluid ctbox"  style="padding:0px;width:100vw;background: #121420;height: 110vh">
    ...
    <div class="box_content">
        <div class="logo fe6im">
            <img src="<?php echo ($waplogo); ?>" class="img_logo">
        </div>
        <P class="title f20 fe6im" style="font-size: 20px;">Welcome to <?php echo get_config('webname');?></P>
        <p class="content fe6im">The <?php echo get_config('webname');?> digital currency exchange was registered in Singapore in 2018 and is a global digital asset financial service platform. Its founding team is composed of senior financial technology professionals from New York and Singapore. The core developers all have the background of top traditional stock exchanges and have independently developed a complete set of exchanges and customer service systems. Adopt the world's leading: more stable, safer and more transparent "spot 3.0 system".
            <?php echo get_config('webname');?> adheres to the "user first" principle, and constantly iterates the underlying technical architecture to improve user experience. Focusing on the development strategy of "spot + contract + wealth management", we provide global users with digital asset financial services focusing on "spot, contract, leverage, binary options, investment and wealth management".
            <?php echo get_config('webname');?> is an international digital asset financial service platform. Its users come from 177 countries around the world, and it has branches in 13 cities including New York, London, Singapore, Ho Chi Minh City, Seoul, and Tokyo. With media resources covering more than 4,000 worldwide, Bitcoin Cash is the world's fastest-growing global station in 2020. Since January this year, 1.65 million new registered users have been added, and the total number of registered users has reached 18 million.
            <?php echo get_config('webname');?> is committed to creating a digital financial service platform with a good customer experience, more new registered users, and a stable and secure technical architecture!
        </p>
    </div>
