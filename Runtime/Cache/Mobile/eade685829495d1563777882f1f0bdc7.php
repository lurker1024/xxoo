	...
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="oreimgbox">
			...
			<div class="fl col-8 pl20 pt20">
				<p class="fe6im ti12 f12"><?php echo L('即享挖矿奖励');?></p>
				<p class="fe6im ti12 f12"><?php echo L('随存随取');?></p>
				<p class="fe6im ti12 f12"><?php echo L('灵活操作');?></p>
			</div>
			<div class="fr  col-4">
				<img src="/Upload/public/<?php echo ($webkj); ?>" class="d-block" style="width:170px;float: right;" />
			</div>
		</div>

		<div class="oplist">
			<div class="listbox hsborder" id="zlbtn">
				<span class="fzmm fcy" id="zlbtn_span"><?php echo L('总览');?></span>
			</div>
				...
				<div style="width:100%;height:120px;">
					...
					<div style="width:70%;height:120px;float:left;padding:5px;">
						...
						<p class="fzmm fcc" style="margin-bottom:0px;text-align:right;">
							<span style="background: #0ecb81;color: #fff;padding: 10px;border-radius: 5px;"><?php echo L('立即购买');?></span>
						</p>
						</a>
					</div>
				</div>
