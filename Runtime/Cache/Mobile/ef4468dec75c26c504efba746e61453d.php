			...
			<div class="orebox">
				<div style="width:100%;height:120px;">
					...
					<div style="width:70%;height:120px;float:left;padding:5px;">
						...
						<p class="fzmm fcc" style="margin-bottom:3px;"><?php echo L('认购单价');?>：<?php echo ($info["price"]); ?> / <?php echo ($info["buycoin"]); ?></p>
				...
				<div style="width:100%;height:60px;margin-top:15px;padding:0px 15px;">
					<div class="obbox" style="width:40%;">
						...
						<div class="obbox_h">
							<span class="fzmm fcc"><?php echo sprintf("%.0f",$info['num']); ?></span>
						</div>
					</div>
					<div class="obbox" style="width:30%;">
						<div class="obbox_h" style="text-align:center;">
							<span class="fzmm fcc"><?php echo L('发行单价');?></span>
						</div>
						<div class="obbox_h" style="text-align:center;">
							<span class="fzmm fcc"><?php echo ($info["yuan_price"]); ?> <?php echo ($info["buycoin"]); ?></span>
						</div>
					</div>
					<div class="obbox" style="width:30%;">
				...
				<div style="width:100%;height:60px;margin-top:5px;padding:0px 15px;border-bottom:1px solid #f5f5f5;">
					<div class="obbox" style="width:40%;">
						...
						<div class="obbox_h">
							<span class="fzmm fcc"><?php if(strtotime($info['starttime']) <= time()){echo sprintf("%.0f",$info['sellnum'] + $info['ysnum']);}else{echo sprintf("%.0f",$info['sellnum']);} ?> </span>
						</div>
					</div>
					<div class="obbox" style="width:30%;">
						<div class="obbox_h" style="text-align:center;">
						...
						<div class="obbox_h" style="text-align:center;">
							<span class="fzmm fcc"><?php echo sprintf("%.0f",$info['allmax']); ?></span>
						</div>
					</div>
					<div class="obbox" style="width:30%;">
						<div class="obbox_h" style="text-align:right;">
