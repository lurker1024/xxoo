	...
	<div class="container-fluid ctbox"  style="padding:0px;width:100vw;height:9600px;background: #121420">
		<div class="no_header">
			...
			<div class="no_title">
				...
				<span class="title_txt fe6im"><?php echo L('通知');?></span>
			</div>
		</div>
		...
		<div class="no_content" style="width:90%;margin:50px auto;">
			<div class="no_inbox">
                <?php if(empty($list)): ?><div style="width:100%;height:200px;line-height:200px;text-align:center;">
                    <span class="fzmm fe6im"><?php echo L('没有通知记录');?></span>
                </div>    
                <?php else: ?>
				...
				<div style="width:100%;height:90px;padding:5px 0px;margin-bottom:10px;">
					...
					<div style="width:90%;height:80px;float:right;">
						<div style="width:100%;height:20px">
							<span class="fzmmm fe6im"><?php echo ($vo["title"]); ?></span>
						</div>
						<div style="width:100%;height:40px;overflow: hidden;">
							<span class="fzm fe6im"><?php echo ($vo["content"]); ?></span>
						</div>
						<div style="width:100%;height:40px">
							<span class="fzm fe6im"><?php echo ($vo["addtime"]); ?></span>
						</div>
					</div>
				</div>
		...
		<div class="bmbtn" id="bmbtn" style="display:none;">
			<div class="bmbtn_l" onclick="allread();">
				<span class="fzm fe6im"><?php echo L('全部已读');?></span>
			</div>
			<div class="bmbtn_r" onclick="alldel();">
				<span class="fzm fe6im"><?php echo L('清除全部');?></span>
			</div>
		</div>
