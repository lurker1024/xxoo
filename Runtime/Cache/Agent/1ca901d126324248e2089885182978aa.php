...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            ...
            <div class="fr">
                <button class="btn btn-warning" onClick="location.href='<?php echo U('Agent/Index/myzc');?>'">初始化搜索</button>
            </div>
        </div>
...
<script type="text/javascript">
    function Upbh(id) {
        ...
        $.post("<?php echo U('Agent/Index/reject');?>", {
            id: zcid
        }, function (data) {
...
<script type="text/javascript">
    function Upzc(id) {
        ...
        layer.load(0, {shade: [0.5,'#8F8F8F']});
        $.post("<?php echo U('Agent/Index/adopttb');?>", {
            id: zcid
        }, function (data) {
            setTimeout("closetanchu()",2000);
            if (data.status == 1) {
...
<script type="text/javascript">
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('Agent/Index/myzc');?>");
    </script>