					...
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									<td class="item-label">原始认购价格:</td>
									<td>
										<input type="text" class="form-control input-10x" name="yuan_price" value="<?php echo ($data['yuan_price']*1); ?>">
									</td>
									<td class="item-note" style="color:red;">* 认购币的原始单价(不可修改) </td>
								</tr>
								...
								<tr class="controls">
									...
									<td class="item-note" style="color:red;">* 认购币的当前单价(会随收益增长波动)</td>
								</tr>
								...
								<tr class="controls" style="border-top:1px dashed #d0d0d0;">
									...
									<tr class="controls">
									<td class="item-label">每日收益 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="lixi" value="<?php echo ($data['lixi']); ?>">
									</td>
									<td class="item-note"  style="color:red;">%</td> 天数 × 该百分比
								</tr>
								<tr class="controls">
