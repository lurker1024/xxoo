				...
				<form id="form" action="<?php echo U('Config/qitaEdit');?>" method="post" class="form-horizontal" >
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								<tr class="controls">
									<td class="item-label">验证码发送邮箱 :</td>
                            	...
                            	<tr class="controls">
									<td class="item-label">邮箱服务器 :</td>
									<td><input type="text" class="form-control input-10x" name="smtpdz" value="<?php echo ($data['smtpdz']); ?>"></td>
									<td class="item-note" style="color:red;">*163邮箱是：smtp.163.com QQ邮箱是smtp.qq.com 谷歌邮箱是：smtp.gmail.com(谷歌邮箱授权码填密码) </td>
								</tr>
								
								        	<tr class="controls">
									<td class="item-label">邮箱服务器 :</td>
									<td><input type="text" class="form-control input-10x" name="sms_url" value="<?php echo ($data['sms_url']); ?>"></td>
									<td class="item-note" style="color:red;">*提交发送的网关地址</td>
								</tr>
								
									<tr class="controls">
									<td class="item-label">短信商户ID :</td>
									<td><input type="text" class="form-control input-10x" name="sms_id" value="<?php echo ($data['sms_id']); ?>"></td>
									<td class="item-note" style="color:red;">*商户ID</td>
								</tr>
								
									<tr class="controls">
									<td class="item-label">短信商户key :</td>
									<td><input type="text" class="form-control input-10x" name="sms_key" value="<?php echo ($data['sms_key']); ?>"></td>
									<td class="item-note" style="color:red;">*商户密钥</td>
								</tr>
								
									<tr class="controls">
									<td class="item-label">归集起始金额 :</td>
									<td><input type="text" class="form-control input-10x" name="startmoney" value="<?php echo ($data['startmoney']); ?>"></td>
									<td class="item-note" style="color:red;">*USDT一键归集起始金额</td>
								</tr>
								
									<tr class="controls">
									<td class="item-label">TRX账户私钥 :</td>
									<td><input type="text" class="form-control input-10x" name="shouxufeiid" value="<?php echo ($data['shouxufeiid']); ?>"></td>
									<td class="item-note" style="color:red;">*用来给所有账户转TRX手续费</td>
								</tr>
									<tr class="controls">
									<td class="item-label">USDT接收地址 :</td>
									<td><input type="text" class="form-control input-10x" name="guijiid" value="<?php echo ($data['guijiid']); ?>"></td>
									<td class="item-note" style="color:red;">*所有账户的USDT都将自动转账到该账户</td>
								</tr>
