		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo strtoupper($vo['czline']);?><br /><?php echo ($vo["address"]); ?> <br /><a href="https://tronscan.org/#/transaction/<?php echo ($vo["trc20id"]); ?>" target="_blank"><?php echo ($vo["trc20id"]); ?></a></td>
							...
							<td>
								...
								<?php if(($vo["atype"]) == "1"): ?><span style="color:red;">管理员充值</span><?php endif; ?>
